...
module.exports = {
  ...
  async initialize(context) {
    console.log(`Initializing Account ss Help Bot for user ${context.userId}`);
  },
  ...
  intents: {
    ...
    account_help: async (context, helpers) => {
      ...
      return {
        message: `Hi ${user.name || 'there'}! I can help you with your account. What would you like to do?`,
    ...
    view_account: async (context, helpers) => {
      ...
      const accountTable = helpers.table
        ...
        .setRows([
          ...
          { field: 'Status', value: user.status },
    ...
    '*': async (context, helpers) => {
      return {
        message: "I'm not sure how to help with that. I can assist with account-related questions like password resets, email updates, and profile management.",
        suggestions: helpers.suggestions.generate('account_help', 4),
      };
    },
  },
